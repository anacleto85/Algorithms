...
import org.coursera.algorithms.p1.week1.unionfind.QuickWeightedUnionUF;
...
{	
	...
	public static void main(String[] args)
	{
		...
		try 
		{
			...
			reader = new BufferedReader(new InputStreamReader(Question2.class.getResourceAsStream("QUESTION2")));
			...
			UF uf = new QuickWeightedUnionUF(N);
